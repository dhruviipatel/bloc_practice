...
import 'package:learn_bloc/bloc/weather_bloc/aditional_info_item.dart';
        ...
        actions: [
          IconButton(
            onPressed: () {
              context
                  .read<WeatherBloc>()
                  .add(WeatherFetch(cityName: selectedCity));
            },
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: DropdownButton(
                      underline: Container(),
                      isExpanded: true,
                      hint: Text(mydata.city.name),
                      items: [
                        DropdownMenuItem(child: Text("Surat"), value: "Surat"),
                        DropdownMenuItem(
                            child: Text("Ahmedabad"), value: "Ahmedabad"),
                        DropdownMenuItem(
                            child: Text("Manali"), value: "Manali"),
                        DropdownMenuItem(
                            child: Text("London"), value: "London"),
